...
public extension UIView {
    ...
    struct OptionalEdge {
        ...
        static var allZero: UIView.OptionalEdge {
...
public extension UIView {
    ...
    // Auto Active
    @discardableResult
    func mLayEqualSafeArea(with item: UIView, direction: LayDirection, constant: CGFloat = 0, active: Bool = true) -> NSLayoutConstraint {
        self.translatesAutoresizingMaskIntoConstraints = false
        if #available(iOS 11.0, *) {
            ...
            let attrib: NSLayoutConstraint.Attribute = direction.getLayoutAttribute()
            return NSLayoutConstraint(item: self,
                                      ...
                                      attribute: attrib,
                                      multiplier: 1,
                                      constant: constant).active(bool: active)
        }
    }
    ...
    func mLaySafe(pin: OptionalEdge, to view: UIView? = nil) -> [NSLayoutConstraint] {
        ...
        var arr: [NSLayoutConstraint] = []
        let view: UIView = view ?? superview!
        if let value: CGFloat = pin.top { arr.append( mLayEqualSafeArea(with: view, direction: .top, constant: value)) }
        if let value: CGFloat = pin.leading { arr.append( mLayEqualSafeArea(with: view, direction: .leading, constant: value)) }
        if let value: CGFloat = pin.bottom { arr.append( mLayEqualSafeArea(with: view, direction: .bottom, constant: -value)) }
        if let value: CGFloat = pin.trailing { arr.append( mLayEqualSafeArea(with: view, direction: .trailing, constant: -value)) }
        return arr
    }
...
public extension UIView {
    ...
    @discardableResult
    func mLayChainEqualSafeArea(with item: UIView, direction: LayDirection, constant: CGFloat = 0, active: Bool = true) -> Self {
